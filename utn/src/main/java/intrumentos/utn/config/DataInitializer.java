...
public class DataInitializer {
    ...
    CommandLineRunner initDatabase(CategoriaRepository categoriaRepository,
        ...
        return args -> {
            ...
            Categoria cuerdas = new Categoria(1L, "Cuerda");
            Categoria viento = new Categoria(2L, "Viento");
            Categoria percusion = new Categoria(3L, "Percusión");
            Categoria teclado = new Categoria(4L, "Teclado");
            Categoria electronico = new Categoria(5L, "Electrónico");
            ...
            instrumentoRepository.saveAll(Arrays.asList(
                    new Instrumento(1L, "Mandolina Instrumento Musical Stagg Sunburst", "Stagg", "M20", "nro10.jpg",
                            2450.00, "G", 28,
                    ...
                    new Instrumento(2L, "Pandereta Pandero Instrumento Musical", "DyM ventas", "32 sonajas", "nro9.jpg",
                            325.00, "150", 10,
                    ...
                    new Instrumento(3L, "Triangulo Musical 24 cm Percusion", "LBP", "24", "nro8.jpg",
                            260.00, "250", 3,
                            ...
                            categoriasMap.get(3L)),
                    new Instrumento(4L, "Bar Chimes Lp Cortina Musical 72 Barras", "FM", "LATIN", "nro7.jpg",
                            2250.00, "G", 2,
                            "BARCHIME CORTINA MUSICAL DE 25 BARRAS LATIN CUSTOM. Emitimos factura A y B",
                            categoriasMap.get(3L)),
                    new Instrumento(5L, "Shekeres. Instrumento. Música. Artesanía.", "Azalea Artesanías",
                            ...
                            categoriasMap.get(3L)),
                    new Instrumento(6L, "Antiguo Piano Aleman Con Candelabros.", "Neumeyer", "Stratus", "nro3.jpg",
                            17000.00, "2000", 0,
                    ...
                    new Instrumento(7L, "Guitarra Ukelele Infantil Grande 60cm", "GUITARRA", "UKELELE", "nro4.jpg",
                            500.00, "G", 5,
                            ...
                            categoriasMap.get(1L)),
                    new Instrumento(8L, "Teclado Organo Electronico Musical Instrumento 54 Teclas", "GADNIC", "T01",
                            "nro2.jpg",
                            2250.00, "G", 1375,
                            ...
                            categoriasMap.get(4L)),
                    new Instrumento(9L, "Instrumentos De Percusión Niños Set Musical Con Estuche", "KNIGHT", "LB17",
                            "nro1.jpg",
                            2700.00, "300", 15,
                            ...
                            categoriasMap.get(3L)),
                    new Instrumento(10L, "Batería Musical Infantil Juguete Niño 9 Piezas Palillos", "Bateria",
                            "Infantil", "nro5.jpg",
                            850.00, "250", 380,
